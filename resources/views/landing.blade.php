  ...
  <div
    ...
    <main
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
        ...
        <div
          ...
          <div class="relative mt-auto">
            ...
            <h2 class="mt-3 leading-relaxed text-zinc-900 dark:text-zinc-200">
              ...
              RIMBA is not just software — it’s a living environment where People, Assets, and Data speak the same language.
              Designed for modern manufacturing and enterprise teams, RIMBA brings everything your organization needs into one unified platform — enabling clarity, efficiency, and smarter decisions at every level.
            </h2>
          </div>
        </div>
        <!-- END Intro -->
          ...
          <div class="relative flex flex-col overflow-hidden rounded-xl bg-zinc-100 p-12 dark:bg-zinc-900">
            ...
            <div class="relative text-center max-w-3xl mx-auto">
              ...
              <p class="mt-4 text-zinc-800 leading-relaxed dark:text-zinc-200">
                ...
                empowering every employee to find, select, and use what they need independently, anytime.
              </p>
            </div>
          </div>
        </div>
        ...
        <!-- Features -->
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          <div class="absolute top-6 right-6 scale-0 opacity-0 transition duration-75 ease-out group-hover:scale-100 group-hover:opacity-100" aria-hidden="true">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Social structure of the elephant herd, Organization connects people within an intelligent and coordinated hierarchy.</h4>
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Owls are universally associated with wisdom and knowledge. Learning is about gaining insight — having the wisdom to act correctly in real-world scenarios.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Honeybees that tirelessly gather and store nectar, the Document system organizes and preserves knowledge for easy retrieval.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Horses are known for their strength and value. Assets are the backbone of operations — reliable, long-lasting, and essential for carrying business forward.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Like a buffalo that continues to move and perseveres through challenges, Tasks drive disciplined execution and continuous progress.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">A butterfly emerging through transformation, Certificates represent achievement, growth, and capability.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a
          ...
          <div
            class="absolute top-6 right-6 scale-0 opacity-0 transition duration-75 ease-out group-hover:scale-100 group-hover:opacity-100"
            aria-hidden="true">
            <div class="w-6 h-6 [&>svg]:w-full [&>svg]:h-full [&>svg]:fill-current">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Just like a bird kicks off the morning, the Calendar keeps everyone informed with work hours, events, and holidays.</h4>
          <div
            class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Like a leopard that guards its territory, Security protects access and enforces control across the system.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">An orangutan that skillfully uses tools, the Service Menu enables flexible and intelligent use of available services.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Turtle diagrams that define inputs, processes, and outputs, Workflows structure operations into clear, controlled, and repeatable steps.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">Eagle's sharp eye from above, Location provides clear visibility and awareness across the operational landscape.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <a id="features" href="javascript:void(0)" class="group relative col-span-1 overflow-hidden rounded-xl bg-zinc-100 p-6 hover:bg-zinc-200/75 active:bg-zinc-200 md:col-span-4 dark:bg-zinc-900 dark:hover:bg-zinc-800/75 dark:active:bg-zinc-800">
          ...
          <h4 class="text-sm text-zinc-600 dark:text-zinc-400">A parrot that listens and repeats exactly as heard, Requests capture instructions clearly and relay them without distortion.</h4>
          <div class="mt-10 transition duration-150 ease-out group-hover:scale-105">
            <div class="rounded-xl object-contain w-full aspect-square">
        ...
        <div
          ...
          <div
            aria-hidden="true"
            class="absolute -right-48 -bottom-48 size-96 rounded-full bg-indigo-200 blur-2xl dark:bg-indigo-400/50"></div>
          <div
            aria-hidden="true"
            class="absolute -top-48 -right-48 size-96 rounded-full bg-purple-200 blur-3xl dark:bg-purple-400/50"></div>
          <div
            aria-hidden="true"
          ...
          <nav class="flex items-center justify-center gap-4">
            ...
            <a
              ...
              <svg
                ...
                fill="currentColor">
                <path
                  d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.378 14.192 5 15.115 5H18V0h-3.808C10.596 0 9 1.583 9 4.615V8z"></path>
              </svg>
            </a>
            <a
              href="javascript:void(0)"
